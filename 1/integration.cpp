...
//double twodintegrand(double, double);
//double twodgausshermiteintegration(int);
...
//  wtime = omp_get_wtime ( );
//  double Integral = twodgausshermiteintegration(n);
...
// Hermite h1(1);
// Hermite h2(2);
// return h1.evaluate(x1)*h2.evaluate(x1);
...
//double twodintegrand(double x1, double y1)
//{
//    HarmonicOscillator2D p(67,1);
//    return pow(p.wavefunction_no_exp(x1,y1),2);
//}

//double twodgausshermiteintegration(int n)
//{
...
//                    Integral += w[i]*w[j]*twodintegrand(x[i],x[j]);
//            }
//      }
